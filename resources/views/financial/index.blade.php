<x-app-layout>
    <div class="container lg:pl-8 pl-6">
        <div class="flex justify-between mb-8 pb-4 items-center">
            <h1 class="text-xl text-white">Semua laporan kamu sudah tertata rapi <span
                    ...
                    <div class="modal-content bg-white bg-opacity-75 rounded-lg px-10 py-12 z-10">
                        ...
                        <form action="{{ route('financial.store') }}" method="POST">
                            ...
                            <div class="flex justify-end">
                                ...
                                <button type="submit"
                                    class="bg-[#20374D] border border-[#20374D] bg-opacity-90 text-white px-4 py-2 rounded-md">Tambah
                                    Laporan</button>
                            </div>
                        </form>
                    </div>
            ...
            @foreach ($financials as $financial)
                <div class="flex flex-row bg-white bg-opacity-10 px-4 py-6 rounded-xl relative shadow-lg">
                    ...
                    <div class="h-50 ml-4 flex w-auto flex-col justify-center text-white">
                        <a href="{{ route('financial.showStatements', $financial->id) }}" class="text-lg font-bold ">
        ...
        <div id="editModal" class="fixed z-50 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title"
            ...
            <div class="flex items-center justify-center min-h-screen">
                ...
                <div class="bg-white bg-opacity-75 z-50 rounded-lg px-10 py-12 max-w-sm mx-auto">
                    ...
                    <form id="editForm" method="POST">
                        ...
                        <div class="flex justify-end">
                            ...
                            <button type="submit"
                                class="bg-[#20374D] border border-[#20374D] bg-opacity-90 text-white font-bold py-2 px-4 rounded">Update</button>
                        </div>
                    </form>
                </div>
            </div>
